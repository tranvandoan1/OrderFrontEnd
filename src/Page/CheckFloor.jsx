...
const CheckFloor = () => {
    ...
    const cancelTable = () => {
        if (confirm('Bạn có muốn hủy bàn này không ?')) {
            ...
            dispatch(deleteSaveOrderAll(deleteSaveOrder))
    ...
    const onclickMoveTable = () => {
        ...
        // console.log(newSaveOrder)
        // const koo = []
        // newSaveOrder.filter(item => {
        //     const lp = { ...item, floor_id: idMoveFloor }
        //     koo.push(lp)
    ...
    return (
        <div>
            ...
            <Modal title="Hủy bàn" visible={cancelTableStatus} onCancel={handleCancel}>
                ...
                {
                    (idFloor && idTable) && <Button type='primary' style={{ marginTop: 10, background: "red", border: 0 }} onClick={() => cancelTable()}>Chuyển bàn</Button>
                }
