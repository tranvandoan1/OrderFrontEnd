        ...
        var _loop = function _loop(vertexIdx) {
          ...
          descriptors.forEach(function (descriptor, attributeIdx) {
            if (descriptor && descriptor.update) {
              ...
              (_ref2 = descriptor.buffer.data).push.apply(_ref2, (0, _toConsumableArray2.default)(descriptor.update(feature, featureIdx, vertice, vertexIdx, normal, vertexIndex)));
            }
          });
        };
        ...
        var _loop2 = function _loop2(vertexIdx) {
          ...
          descriptors.forEach(function (descriptor, attributeIdx) {
            if (descriptor && descriptor.update) {
              ...
              (_ref3 = descriptor.buffer.data).push.apply(_ref3, (0, _toConsumableArray2.default)(descriptor.update(feature, featureIdx, vertice, vertexIdx, normal, vertexIndex)));
            }
          });
        };
