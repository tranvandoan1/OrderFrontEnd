...
var getTileImage = function () {
  var _ref = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(url, tile) {
    var imgUrl;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            imgUrl = getURLFromTemplate(url, tile);
...
export default function rasterTile(data, cfg) {
