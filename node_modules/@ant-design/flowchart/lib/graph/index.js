...
var Flowchart = function (props) {
    var _a = props, className = _a.className, style = _a.style, detailPanelProps = _a.detailPanelProps, toolbarPanelProps = _a.toolbarPanelProps, _b = _a.nodePanelProps, nodePanelProps = _b === void 0 ? {} : _b, scaleToolbarPanelProps = _a.scaleToolbarPanelProps, _c = _a.contextMenuPanelProps, contextMenuPanelProps = _c === void 0 ? {} : _c, _d = _a.canvasProps, canvasProps = _d === void 0 ? {} : _d, keyBindingProps = _a.keyBindingProps, 
    // miniMapProps = {},
    ...
    var _e = canvasProps.position, position = _e === void 0 ? { top: 40, left: 240, right: 240, bottom: 0 } : _e;
    ...
    var _f = scaleToolbarPanelProps.show, show = _f === void 0 ? true : _f;
    var _g = nodePanelProps.show, nodePanelShow = _g === void 0 ? true : _g;
            ...
            react_1.default.createElement(xflow_1.XFlow, { className: className, style: style, commandConfig: commandConfig, onAppDestroy: onDestroy, isAutoCenter: isAutoCenter, onAppConfigReady: onConfigReady, onLoad: function (app) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                react_1.default.createElement(xflow_1.FlowchartCanvas, { config: __assign(__assign({}, canvasProps), { onAddNode: onAddNode, onAddEdge: onAddEdge, onConfigChange: onConfigChange }), mode: mode, position: position },
                    show && (react_1.default.createElement(xflow_1.CanvasScaleToolbar, __assign({ layout: "horizontal", position: { top: 12, right: 12 }, style: {
                        ...
                        } }, Object.assign({}, constants_1.DEFAULT_SCALE_TOOLBAR_PROPS, scaleToolbarPanelProps)))),
